...
while (true) {
let fruit_name = prompt("Enter the fruit name (type 'no' to stop):");
...
while (true) {
let purchase_fruit = prompt("Enter the fruit you want to buy (type 'no' to stop):");
...
purchase_fruit = prompt("do you want to buy another fruit (type 'yes, To continue 'no' to stop):");
